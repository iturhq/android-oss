...
import cat.itur.app.core.auth.health.reportFirebaseAuthFailed
import cat.itur.app.core.auth.health.reportFirebaseAuthSucceeded
...
/**
 * A [cat.itur.app.core.data.repository.UserRepository] that uses Firebase Authentication.
 */
