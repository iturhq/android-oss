...
class PermissionUseCasesTest {
    ...
    fun uc01_grantingLocationPermissionShowsIdleMapControls() {
        ...
        composeRule.waitUntil(timeoutMillis = 10_000) {
            composeRule.onAllNodesWithTag("join_activity_fab").fetchSemanticsNodes().isNotEmpty()
        }
    ...
    fun uc02_denyingLocationPermissionShowsGuidanceWithoutMapControls() {
        clickPermissionChoice("Deny", "Don't allow")
    ...
    private fun clickPermissionChoice(vararg labels: String) {
        val selector = labels.asSequence()
            .mapNotNull { label ->
